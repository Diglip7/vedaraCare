export const neckPainPhysioHero = {
  breadcrumb: [
    { label: "Home", href: "/" },
...
export const neckPainWhyEpidemic = {
  bgColor: "bg-[#F8F5EE]",
  label: "UNDERSTANDING NECK PAIN",
  title: "Why neck pain has become epidemic in modern life.",
  description: "Most neck pain is not from a single injury — it builds over weeks, months, or years from sustained patterns. Understanding the cause helps explain the treatment.",
  image: "/images/tech-neck-forward-head-posture-illustration.webp",
  alt: "Forward head posture and cervical biomechanics educational illustration",
  imageLeft: false,
  showStats: true,
  content: [
    "The human cervical spine evolved to support a head weighing approximately 5kg in a neutral upright position. Modern life — desks, screens, devices, sustained postures — frequently positions the head forward of neutral, which dramatically increases the load on cervical muscles and joints.",
    "The physics is striking. For every 2.5cm the head moves forward of neutral, the effective weight on the cervical spine roughly doubles. A head tilted forward 15 degrees creates approximately 12kg of effective load. At 30 degrees — typical when looking down at a phone — the load reaches 18kg. Modern adults sustain these positions for hours daily.",
    "<strong>The Dubai context</strong><br/>Dubai's expat workforce is concentrated in desk-intensive industries — finance, technology, government, professional services. Combined with long working days (often 9–11 hours) and significant device use, the sustained postural load is substantial. Neck pain has become one of the most common physiotherapy presentations across Dubai's working population.",
    "<strong>The patterns we see most often</strong><br/>Forward head posture with rounded shoulders, upper trapezius tension, weakness in the deep cervical flexor muscles, restricted thoracic spine mobility, and protective muscle guarding. Each component contributes to the others. The pattern develops gradually, often goes unnoticed for years, and presents as pain only when the system can no longer compensate.",
    "<strong>The good news</strong><br/>Modern evidence-based physiotherapy is highly effective for most neck pain. Manual therapy releases acute symptoms. Structured exercise addresses the underlying postural patterns. Education enables long-term self-management. Most patients see substantial improvement within 6–12 weeks. The body that developed the pattern can also unwind it — with the right approach."
  ],
  quote: "Most modern neck pain is not really about the neck. It is about the system that holds the head — and the patterns the system has fallen into."
};

export const neckPainConditions = {
  bgColor: "bg-white",
  label: "Specific Neck Pain Types",
  title: "The patterns we treat at our JVC clinic.",
  description: "Different neck pain patterns require different treatment approaches. Identifying your specific pattern is the first step.",
  types: [
    {
      number: "01",
    ...
    },
    {
      ...
      description: "Long-standing neck pain persisting beyond normal healing — often from sustained postural patterns, repetitive strain, or untreated acute episodes. Requires comprehensive programme combining manual therapy, postural correction, motor control training, and strengthening over 3–6 months.",
      typicalSigns: "Ongoing tension, worse with sustained activity, improves with movement and rest"
    },
    {
      number: "03",
      title: "Forward Head Posture / 'Tech Neck'",
      description: "Sustained forward head positioning from device use and desk work — the most common pattern in Dubai's working population. Treatment focuses on deep cervical flexor strengthening, thoracic spine mobility, postural correction exercises, and ergonomic habit change.",
      typicalSigns: "Visible forward head position, upper back stiffness, headaches, end-of-day fatigue"
    },
    {
      number: "04",
...
export const neckPainShouldYouSee = {
  ...
  description: "Most neck pain is appropriate for physiotherapy treatment. However, some presentations require different approaches — medical evaluation, imaging, or specialist referral. Here is guidance on whether physiotherapy is the right next step.",
  physiotherapyFirst: [
    "Your neck pain is mechanical (related to movement, position, or activity)",
    "The pain started without specific significant trauma",
    "You do not have progressive neurological symptoms (significant arm weakness, numbness affecting daily function)",
    "Your pain has lasted more than a week and is not improving",
    "You have recurring episodes of neck pain",
    "Postural or work-related patterns seem to contribute",
...
export const neckPainHowTreat = {
  ...
  alt: "Evidence-based neck pain physiotherapy treatment at Vedara Care JVC",
  title: "How we actually treat neck pain at our JVC clinic.",
  content: [
...
export const neckPainPhases = {
  ...
  description: "A representative progression. Acute, subacute, and chronic neck pain follow somewhat different patterns. Your specific timeline is calibrated to your presentation.",
  phases: [
    {
      number: "01",
      ...
      items: [
        ...
        "Manual therapy for acute symptom modulation",
        "Gentle mobilisation within tolerance",
        "Activity modification guidance",
        "Education about your specific pattern",
        "Beginning of postural awareness work"
      ],
      expected: "Substantial symptom reduction; understanding of your pattern; basic movement restored."
    },
    {
      number: "02",
      ...
      items: [
        "Manual therapy continuing as needed (frequency reducing)",
        "Structured exercise programme initiated",
    ...
    {
      number: "03",
      title: "Strengthening and Integration",
      duration: "Weeks 8–16",
      frequency: "Bi-weekly or monthly",
      items: [
        "Exercise programme progresses in loading and complexity",
        "Manual therapy as needed for residual patterns",
        "Building postural endurance",
        "Sport or activity-specific progression where relevant",
        "Home programme deepens"
      ],
      expected: "Most patients resolved or substantially improved; sustainable patterns established."
    },
    {
      number: "04",
      title: "Maintenance and Prevention",
      duration: "Months 4+",
      frequency: "Periodic as needed",
      items: [
        "Discharge with home programme (acute presentations)",
        "Ongoing periodic care for chronic patterns",
        "Annual review for recurrent patterns",
        "Self-management capability fully established",
        "Return-to-clinic as needed for flare-ups"
      ],
      expected: "Stable outcomes; recurrence prevention established; long-term self-management capability."
    }
  ],
  footer: "These phases are illustrative. Acute presentations often resolve in Phases 1–2 only. Chronic patterns typically extend through all four phases. Your specific timeline is documented at initial assessment."
};

export const neckPainModalities = {
  label: "Techniques and Modalities",
  title: "Evidence-based physiotherapy techniques for neck pain.",
  modalities: [
    {
      number: "01",
