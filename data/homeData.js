...
export const homeInsights = {
  ...
  items: [
    { category: "Ayurveda", title: "Ayurveda for PCOS: A Natural Approach to Hormonal Balance", readTime: "5 min read" },
    { category: "Physiotherapy", title: "Best Treatments for Back Pain in Dubai: What Actually Works", readTime: "7 min read" },
    { category: "Physiotherapy", title: "Physiotherapy vs Chiropractic: Which is Right for You?", readTime: "6 min read" },
    { category: "Dermatology", title: "Hair Loss Causes in Dubai's Climate: Expert Insights", readTime: "5 min read" }
  ]
};
