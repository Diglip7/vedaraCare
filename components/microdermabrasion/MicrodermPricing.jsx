  ...
  return (
    <section style={{ backgroundColor: 'rgb(245, 240, 232)', padding: '96px clamp(24px, 6vw, 120px)' }}>
      <div style={{ textAlign: 'center', marginBottom: '64px' }}>
        ...
        <h2 style={{ fontFamily: 'Fraunces, Georgia, serif', fontSize: 'clamp(28px, 4vw, 44px)', fontWeight: '400', color: 'rgb(31, 31, 31)', marginBottom: '16px' }}>
      ...
      <div style={{ overflowX: 'auto', borderRadius: '8px', border: '1px solid rgba(200, 168, 127, 0.3)' }}>
        <table style={{ width: '100%', borderCollapse: 'collapse', backgroundColor: 'rgb(255, 255, 255)' }}>
          ...
          <tbody>
            {[
              { service: 'Comprehensive Skin Analysis with Arfah (first-visit foundation)', duration: '30 min', price: 'AED [X] (waived with same-day treatment)', bg: 'rgb(255, 255, 255)' },
              { service: 'Diamond-Tip Microdermabrasion (single session)', duration: '20-30 min', price: 'From AED [X]', bg: 'rgb(245, 240, 232)' },
              { service: 'Crystal Microdermabrasion (single session)', duration: '20-30 min', price: 'From AED [X]', bg: 'rgb(255, 255, 255)' },
              { service: 'Dermaplaning (single session)', duration: '20-30 min', price: 'From AED [X]', bg: 'rgb(245, 240, 232)' },
              { service: 'Combined Dermaplaning + Microdermabrasion', duration: '45-60 min', price: 'From AED [X]', bg: 'rgb(255, 255, 255)' },
              { service: 'Dermaplaning + HydraFacial Combined Protocol', duration: '75-90 min', price: 'From AED [X]', bg: 'rgb(245, 240, 232)' },
              { service: 'Dermaplaning + Oxy-Geneo Combined Protocol', duration: '75-90 min', price: 'From AED [X]', bg: 'rgb(255, 255, 255)' },
              { service: 'LED Light Therapy add-on (Blue or Red)', duration: '+15 min', price: 'From AED [X]', bg: 'rgb(245, 240, 232)' },
              { service: '3-Session Microdermabrasion Programme', duration: '3 months', price: 'From AED [X]', bg: 'rgb(255, 255, 255)' },
              { service: '3-Session Dermaplaning Programme', duration: '3 months', price: 'From AED [X]', bg: 'rgb(245, 240, 232)' },
              { service: '6-Session Microdermabrasion Programme', duration: '6 months', price: 'From AED [X]', bg: 'rgb(255, 255, 255)' },
              { service: '6-Session Dermaplaning Programme', duration: '6 months', price: 'From AED [X]', bg: 'rgb(245, 240, 232)' },
              { service: '6-Session Alternating Programme', duration: '6 months', price: 'From AED [X]', bg: 'rgb(255, 255, 255)' },
              { service: 'Bridal Combined Protocol (Dermaplaning + Oxy-Geneo pre-wedding sequence)', duration: 'Bespoke', price: 'Consultation required', bg: 'rgb(245, 240, 232)' },
              { service: 'Monthly Membership (single modality or alternating)', duration: 'Rolling monthly', price: 'From AED [X]/month', bg: 'rgb(255, 255, 255)' },
              { service: 'Follow-up consultation (existing patient, no treatment)', duration: '20 min', price: 'AED [X]', bg: 'rgb(245, 240, 232)' }
            ].map((row, idx) => (
              <tr key={idx} style={{ backgroundColor: row.bg, borderBottom: '1px solid rgba(200, 168, 127, 0.15)' }}>
      ...
      <div style={{ display: 'flex', gap: '16px', flexWrap: 'wrap', justifyContent: 'center', marginTop: '48px' }}>
        <button style={{ backgroundColor: 'rgb(200, 168, 127)', color: 'rgb(255, 255, 255)', borderWidth: 'medium', borderStyle: 'none', borderColor: 'currentcolor', borderImage: 'none', borderRadius: '8px', height: '56px', padding: '0px 32px', fontSize: '16px', fontWeight: '600', cursor: 'pointer', fontFamily: 'Inter, system-ui, sans-serif', transition: 'background 0.2s', whiteSpace: 'nowrap' }}>
          Book Treatment at JVC
        </button>
        <a href="#" className="gold-link" style={{ fontFamily: 'Inter, system-ui, sans-serif', fontSize: '16px', fontWeight: '500', display: 'flex', alignItems: 'center' }}>
          WhatsApp us for programme pricing questions →
        </a>
      </div>
    </section>
  );
...
export default MicrodermPricing;
