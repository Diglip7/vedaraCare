...
const PhysiotherapyIntegration = () => {
  return (
        ...
        <div className="grid lg:grid-cols-[60fr_40fr] gap-12">
          ...
          <div className="space-y-6">
            <div className="rounded-xl p-7" style={{ border: '2px solid rgb(201, 168, 76)', background: 'rgb(255, 255, 255)' }}>
              ...
              <ul className="space-y-2 mb-6">
                ...
                <li className="flex items-start gap-2 text-sm" style={{ color: 'rgb(26, 26, 26)' }}>
                  ...
                  Optimal loading (not absolute rest in most cases)
                </li>
                <li className="flex items-start gap-2 text-sm" style={{ color: 'rgb(26, 26, 26)' }}>
                  <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="mt-0.5 flex-shrink-0" style={{ color: 'rgb(27, 67, 50)' }}>
                    <circle cx="12" cy="12" r="10"></circle>
              ...
              <div className="rounded-lg p-4" style={{ background: 'rgb(254, 242, 242)', border: '1px solid rgba(212, 24, 61, 0.15)' }}>
                <p className="text-xs font-bold mb-3 flex items-center gap-2" style={{ color: 'rgb(212, 24, 61)' }}>
                  <svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <path d="m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3"></path>
                    <path d="M12 9v4"></path>
                    <path d="M12 17h.01"></path>
                  </svg>
                  Red flags requiring A&E first:
                </p>
                <ul className="space-y-1.5">
                  <li className="text-xs flex items-start gap-2" style={{ color: 'rgb(107, 107, 107)' }}>
                    <span className="mt-1 w-1 h-1 rounded-full flex-shrink-0 bg-red-400"></span>
                    Suspected fracture (severe pain, deformity)
                  </li>
                  <li className="text-xs flex items-start gap-2" style={{ color: 'rgb(107, 107, 107)' }}>
                    <span className="mt-1 w-1 h-1 rounded-full flex-shrink-0 bg-red-400"></span>
                  ...
                  <li className="text-xs flex items-start gap-2" style={{ color: 'rgb(107, 107, 107)' }}>
                    <span className="mt-1 w-1 h-1 rounded-full flex-shrink-0 bg-red-400"></span>
                    Head injury with concussion symptoms
                  </li>
                </ul>
              </div>
            </div>
            <div className="flex flex-col gap-3">
              ...
              <a href="tel:+971 55 573 6312" className="flex items-center justify-center gap-2 px-6 py-4 rounded-lg text-sm font-semibold transition-all hover:opacity-90 border" style={{ color: 'rgb(27, 67, 50)', borderColor: 'rgb(27, 67, 50)' }}>
...
export default PhysiotherapyIntegration;
