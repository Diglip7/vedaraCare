        ...
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <div className="lg:w-2/3">
            <h2 className="text-3xl md:text-4xl font-serif text-[#2C3E3A] mb-12">
              What patients ask about HydraFacial<br className="hidden md:block" /> at our JVC clinic.
            </h2>
          ...
          <div className="lg:w-1/3 space-y-6">
            ...
            <div className="bg-[#C9A55A] p-8 rounded-lg text-center">
              <h3 className="text-white font-serif text-xl mb-6">Book HydraFacial at our JVC clinic</h3>
