        ...
        <div className="mt-10 border-t pt-6">
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              disabled={!isMounted}
              className={`px-4 py-2 rounded-lg text-sm font-semibold transition-colors ${getCurrentReaction() === 'like'
            ...
            <button
              ...
              disabled={!isMounted}
              className={`px-4 py-2 rounded-lg text-sm font-semibold transition-colors ${getCurrentReaction() === 'dislike'
